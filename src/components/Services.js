        ...
        switch(selected){
            ...
            case 2:
                setTitle(<>
                    ...
                    />
                    <h6>CUSTOM AGENCY</h6>
                    <p>With Ammex, exported-imported products are streamlined thanks to our in-house custom agency. Which is how we help you to keep focussed on making your business grow.</p>
                </>)
                setSideBar(<>
                    <div>
                        <p className="h7"><span className="black">Our in-house custom agency offices both in US and Mexico ensure exported-imported product is streamlined through:</span></p>
                    </div>
                    <div>
                        <ul className="h7">
            ...
            case 3:
                setTitle(<>
                    ...
                    <p>Transporting product across the border requires to ensure product is handled correctly. In Ammex, we offer transportation from the US to Mexico in authorized and up to date compliance vehicles.</p>
                </>)
                setSideBar(<>
                    <div>
            ...
            case 4:
                setTitle(<>
                    ...
                    <p>All exporting meats and other foods must be certified by USDA to ensure they meet exporting requirements and wholesomeness. You don't have to worry about it as we count with an in-house USDA office.</p>
                </>)
                setSideBar(<>
                    <div>
                        <p className="h7"><span className="black">As one of California’s top  exporting plants along with:  State of the art facilities.</span></p>
            ...
            case 5:
                setTitle(<>
                    ...
                    <p>Imported Meats into Mexico must be verified and inspected by SAGARPA-SENASICA Mexican officials to ensure product meets requirements for wholesomeness, documentation and traceability. In Ammex, we are committed to transport and deliver your products on top conditions to the SAGARPA verification point in Mexico.</p>
                </>)
                setSideBar(<>
                    <div>
